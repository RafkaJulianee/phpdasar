        ...
        <tbody>
          ...
          ?>
            <tr>
              ...
              <td><?= $row['jurusan']; ?></td>
              <td>
                <a class="btn" style="color:green;" href="edit.php?id=<?= $row['id']; ?>">Edit</a>
                <a class="btn" style="color:red;" href="hapus.php?id=<?= $row['id']; ?>" onclick="return confirm('Yakin mau hapus data ini?')">Hapus</a>
              </td>
            </tr>
          <?php } ?>
        </tbody>
