<?php
include 'koneksi.php'; // koneksi lama kamu
    ...
    <section class="form">
        <div class="logo">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" d="M12 2.25l2.25 1.313L12 4.875 9.75 3.563 12 2.25zM3 7.5l2.25 1.313V16.5L3 15.187V7.5zm18 0v7.688l-2.25 1.312V8.813L21 7.5zm-9 15l-2.25-1.312L12 18.75l2.25 2.438L12 22.5z" />
            </svg>
        </div>
        <h1 class="form__title">Create your Account</h1>
        <p class="form__description">Join now! Fill in your details below</p>
        ...
        <form method="POST" action="">
            ...
            <div class="password-field">
                <input type="password" class="form-control" minlength="4" id="password" name="password" required>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
